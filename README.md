...
2. Создает структуру папок локально
3. Скачивает только новые или измененные файлы
4. Создает пустые файлы для видео и больших файлов
5. Сохраняет метаданные для отслеживания изменений
